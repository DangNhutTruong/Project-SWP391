  ...
  return (
    <div style={{ padding: '20px', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div style={{ marginBottom: '20px', padding: '15px', backgroundColor: '#f3f4f6', borderRadius: '8px' }}>
        ...
        {user && (
          <p><strong>User:</strong> {user.name || user.FullName || user.email || 'Unknown'}</p>
        )}
      </div>
          ...
          return (
            <div 
              ...
              style={{
                ...
                borderRadius: '6px',
                backgroundColor: result ? (result.status === 'success' ? '#f0fdf4' : result.status === 'error' ? '#fef2f2' : '#fefce8') : '#ffffff'
              }}
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{ 
                  ...
                  padding: '4px 8px', 
                  borderRadius: '4px',
                  backgroundColor: result ? getStatusColor(result.status) : '#6b7280',
                  color: 'white'
                }}>
                  {test.endpoint}
                </span>
