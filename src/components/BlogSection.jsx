  ...
  const blogPosts = [
    {
      ...
      excerpt: 'Tuần đầu tiên luôn là giai đoạn khó khăn nhất. Hãy tìm hiểu những phương pháp hiệu quả để vượt qua cơn thèm thuốc...',
      url: '/blog/7-ngay-dau'
    },
    {
      id: 2,
      ...
      excerpt: 'Câu chuyện cảm động về hành trình 365 ngày không thuốc lá và những thay đổi tích cực trong cuộc sống...',
    ...
    },
    {
      ...
      excerpt: 'Khám phá 10 thói quen lành mạnh có thể thay thế việc hút thuốc và giúp bạn duy trì lối sống không khói thuốc...',
            ...
            <div key={post.id} className="blog-card">
              <div className="blog-image">
                ...
                <div className="blog-meta">
                  ...
                  <span className="views"><i className="far fa-eye"></i> {post.views} lượt đọc</span>
                </div>
              </div>
