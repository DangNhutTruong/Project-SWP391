...
} from "../utils/membershipTestHelpers";
...
const MembershipAccessTester = () => {
  ...
  const styles = {
    ...
    accessStatus: {
      ...
      padding: "5px",
      borderRadius: "3px",
      backgroundColor: accessStatus?.hasAccess
        ? "rgba(76, 175, 80, 0.3)"
        : "rgba(244, 67, 54, 0.3)",
    },
    checkButton: {
  ...
  return (
    <div style={styles.container}>
      <button
        ...
        onClick={() =>
          document.body.removeChild(
            document.getElementById("membership-tester")
          )
        }
      >
        ✕
      ...
      <div style={styles.userInfo}>
        ...
        <div>
          <strong>Current Membership:</strong> {user?.membership || "free"}
        </div>
      </div>
      ...
      {accessStatus && (
        ...
        >
          <div>
            ...
            {accessStatus.hasAccess ? "Yes ✓" : "No ✗"}
          </div>
          <div>
            <strong>Reason:</strong> {accessStatus.reason}
          </div>
          <div>
            <strong>Membership:</strong> {accessStatus.membership}
          </div>
        </div>
      )}
