  ...
  return (
    <div className="mood-tracking">
      <div className="mood-header">
        ...
        <p>
          Chia sẻ cảm nhận của bạn về quá trình cai thuốc ngày{" "}
              ...
              return (
                <div
                  ...
                  className={`mood-option ${
                    moodData.mood === mood.id ? "selected" : ""
                  }`}
                  onClick={() =>
                    !isSubmitted && handleInputChange("mood", mood.id)
                  }
                  style={{
                    borderColor:
                      moodData.mood === mood.id ? mood.color : "#e0e0e0",
                  }}
                >
                  <IconComponent
                    className="mood-icon"
